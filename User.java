...
public class User {
    ...
    private static void handleDesiredOption(int desiredOption, Scanner read, Scanner read1) {
        ...
        if (desiredOption == 1) {
            handleAdminLogin(r1, c1, read1);
        } else if (desiredOption == 2) {
            handleAdminRegistration(r1, read1, countNumOfUsers);
        } else if (desiredOption == 3) {
            handlePassengerLogin(r1, c1, bookingAndReserving, read, read1);
    ...
    private static void handleAdminLogin(RolesAndPermissions r1, Customer c1, Scanner read1) {
    ...
    private static void handlePassengerLogin(RolesAndPermissions r1, Customer c1, FlightReservation bookingAndReserving, Scanner read, Scanner read1) {
