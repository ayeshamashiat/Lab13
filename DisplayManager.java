...
public class DisplayManager {
    ...
    public DisplayManager(Flight flight) {
        this.flight = flight;
    }
    ...
    private String toString(int serialNum, Flight flights, Customer customer) {
    ...
    private String toString(int serialNum, Customer customer, int index) {
